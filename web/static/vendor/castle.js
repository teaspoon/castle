...
Elm.Castle = Elm.Castle || {};
Elm.Castle.make = function (_elm) {
   "use strict";
   _elm.Castle = _elm.Castle || {};
   if (_elm.Castle.values) return _elm.Castle.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   return _elm.Castle.values = {_op: _op,main: main};
};
